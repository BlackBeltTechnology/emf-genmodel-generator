...
public class CliGeneratorStandaloneSetup extends AbstractGenModelGeneratorStandaloneSetup {

    private CliConfig cliConfig;

    public void setConfig(CliConfig cliConfig) {
    ...
    public Module getDynamicModule () {
        return new AbstractModule() {
            ...
            protected void configure() {
                bind(GeneratorConfig.class).toInstance(cliConfig);
